...
class Mw(KParts.MainWindow):
	...
	self.TB_history_prev.setIconSize(QSize(55,55))
	self.TB_history_prev.setIcon(QtGui.QIcon("Resources/icons/history-prev.png"))
        ...
        self.TB_page_tab = QtGui.QToolButton(self.horizontalLayout)
        self.TB_page_tab.setMinimumSize(QtCore.QSize(35,35))
        self.TB_page_tab.setObjectName("TB_page_tab")
        self.hboxlayout1.addWidget(self.TB_page_tab)
    ...
    def retranslateUi(self):
        ...
        self.TB_page_tab.setText(QtGui.QApplication.translate("mainwindow", "...", None, QtGui.QApplication.UnicodeUTF8))
